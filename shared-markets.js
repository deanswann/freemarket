...
function installHomepageV2(){
  ...
  style.textContent=`
    ...
    .hero{grid-template-columns:minmax(0,1.45fr) minmax(270px,.55fr);margin-bottom:30px}.hero.probora-home-hidden{display:none!important}.hero-main{padding:34px}.hero h1{max-width:680px;font-size:44px}.hero p{max-width:720px}.hero-side{display:flex;flex-direction:column;justify-content:center}.hero-side .notice{margin-top:16px;background:#111820;border-color:#25333e;color:#b9c6d0}
  ...
  window.eval(`
    ...
    function render(){
      ...
      const hero=document.querySelector('.hero');if(hero)hero.classList.toggle('probora-home-hidden',activeCat!=='All'||!!q||view!=='markets');
